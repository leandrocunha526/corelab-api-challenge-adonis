...
export const storeTaskValidator = vine.compile(
  vine.object({
    ...
    color: vine.string().trim().minLength(3).maxLength(6).optional(), // The hexadecimal color code is at least 3 characters long as #f00 and at most 6 characters long as #ffffff
